...
to build it you need to install [MASM 64 SDK](https://masm32.com/board/index.php?board=53.0) and modify ReplSdk.asm and change paths to win64.inc, kernel32.inc, kernel32.inc, user32.inc, vasily.inc, macros64.inc according to your installation of MASM 64 SDK
